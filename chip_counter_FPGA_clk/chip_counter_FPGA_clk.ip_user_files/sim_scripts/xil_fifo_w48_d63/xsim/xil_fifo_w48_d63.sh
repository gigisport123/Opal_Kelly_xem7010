...
#
# Script generated by Vivado on Fri Feb 16 15:32:04 -0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xil_fifo_w48_d63.sh
...
#
# Usage        : xil_fifo_w48_d63.sh
#                xil_fifo_w48_d63.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xil_fifo_w48_d63.sh [-reset_run]
#                xil_fifo_w48_d63.sh [-reset_log]
#                xil_fifo_w48_d63.sh [-help]
#
...
# script info
echo -e "xil_fifo_w48_d63.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xil_fifo_w48_d63.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xil_fifo_w48_d63 xil_defaultlib.xil_fifo_w48_d63 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xil_fifo_w48_d63 -key {Behavioral:sim_1:Functional:xil_fifo_w48_d63} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xil_fifo_w48_d63.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xil_fifo_w48_d63.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xil_fifo_w48_d63.sh [-help]\n\
Usage: xil_fifo_w48_d63.sh [-step]\n\
Usage: xil_fifo_w48_d63.sh [-lib_map_path]\n\
Usage: xil_fifo_w48_d63.sh [-reset_run]\n\
Usage: xil_fifo_w48_d63.sh [-reset_log]\n\
Usage: xil_fifo_w48_d63.sh [-keep_index]\n\
Usage: xil_fifo_w48_d63.sh [-noclean_files]\n\n\
