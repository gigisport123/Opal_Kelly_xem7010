...
HD_PWD='C:/Users/gigis/opal_kelly_code/chip_counter_FIFO/chip_counter_FIFO.runs/xil_fifo_w48_d63_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xil_fifo_w48_d63.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xil_fifo_w48_d63.tcl
