...
#                script (type 'xil_fifo_w48_d63.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xil_fifo_w48_d63 xil_defaultlib.glbl -o xil_fifo_w48_d63_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xil_fifo_w48_d63_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key xil_fifo_w48_d63_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xil_fifo_w48_d63_simv.daidir vcs_lib c.obj)
