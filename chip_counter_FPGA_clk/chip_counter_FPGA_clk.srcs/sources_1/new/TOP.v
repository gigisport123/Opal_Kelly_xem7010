...
//    wire clk_2fs;               // 2fs; generated from clk wizard
    ...
    wire clk_in_2fs_shifted_buf;    // buffered 2fs input external clock
    ...
    FIFO_top U_FIFO_top(
        .rst (rst),
// these two lines below are for internal clock generator
//        .clk_fs (clk_fs),
//        .clk_2fs (clk_2fs),
// these two lines below are for external clocks
        .clk_fs (clk_in_buf),
        .clk_2fs (clk_in_2fs_shifted_buf),
        .ti_clk (ti_clk),
...
//        .fifo_full (fifo_full)        // trigger signal for fifo full
    ...
    IBUF ext_clk_2fs(.O(clk_in_2fs_shifted_buf), .I(clk_in_2fs_shifted));
